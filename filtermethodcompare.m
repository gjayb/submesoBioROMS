...
days1=5+days1/86400;
days=5+days/86400;
%% plot wb, 5x filter method for submeso
figure; 
subplot(2,3,1)
...
hold on; plot(days1,Mldpop,'k')
 axis tight; datetick('x',3,'keeplimits'); ylim([-350 -5]); %colorbar
...
axis tight; datetick('x',3,'keeplimits'); ylim([-150 -5]); %colorbar
...
%% plot wb, mean and linear trend removed for submeso
...
hold on; plot(days1,Mldpop1,'k')
%% plot wp, 5x filter method for submeso
...
%% plot wp, linear trend removed for submeso
figure; 
